...
%>
  ...
  <tr>
    <td width="686" height="535" valign="top"><table width="100%" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td height="55"><div align="center" class="style1"><font color="#FFFFFF" face="Verdana, 新細明體">■ 回應主題 ■</font>
              <font color="#FFFFFF" face="Verdana, 新細明體"><font color="#FFFFFF" face="Verdana, 新細明體">
              <%
   String userid = (String)session.getAttribute("userid");
   
   
%>
              </font></font>              <div align="center" class="style1"><font color="#FFFFFF" face="Verdana, 新細明體"><font color="#FFFFFF" face="Verdana, 新細明體">            </font></font></div>
          </div></td>
        </tr>
        <tr>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                      ...
                      <tr>
                        ...
                        <td width="450" height="30"><font size="2" face="新細明體"> 　
                              <input name="re_poster" type="hidden" id="re_poster" value="<% out.print(userid); %>" />
</font><font color="#FFFFFF" face="Verdana, 新細明體">
<% out.print(userid); %>
</font><font size="2" face="新細明體">&nbsp;                        </font></td>
                        <td width="123" height="120" rowspan="4" align="center"> <img src="images/face/anger.gif" name="faceimg" width="100" height="120" border="1" id="faceimg" > </td>
                      </tr>
                      <tr> </tr>
                      <tr>
                        <td height="30" bgcolor="#a3d3ad">
