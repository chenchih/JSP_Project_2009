...
%>
          <span class="style29">||</span> <span class="style29"><a href="bulletin_news.jsp" class="style24">相關消息</a> || <a href="lesson.jsp" class="style24">課程</a> || <a href="forum.jsp" class="style24">討論區</a> ||<a href="message.jsp" class="style24">留言</a> || <a href="linkpage.jsp" class="style24">連結</a></span></div></td>
      </tr>
    </table>
	<p>&nbsp;</p>
  ...
  <tr>
    <td width="771" align="center" valign="top"><table  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
	  ...
	  %></td>
        ...
        <tr>
          <td><table width="342" border="3" align="center" cellpadding="1" cellspacing="2" bordercolor="#6F921A">
              <tr>
                <td width="328" valign="top" bgcolor="#FFFFFF"><img src="images/forum_pic.jpg" width="750" height="110" /></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="bottom">
            <table width="106%" height="100%" border="0" align="center" cellpadding="1" cellspacing="2">
              <tr valign="bottom">
                <td width="25%" height="50"><a href="forum_add.jsp"><img src="images/forum_add.gif" width="120" height="48" border="0"></a></td>
                <td width="71%" valign="middle">                    <span class="style18">                                      </span>                  <table width="100%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FF9933">
                    <tr>
                ...
                <td width="4%"><a href="admin_login.jsp"></a></td>
              </tr>
          </table>          </td>
        </tr>
      </table>
        <table width="100%" align="center" cellpadding="2" cellspacing="1" class="box">
          ...
          <tr valign="middle" bgcolor="#FFFFFF">
            <td ><%=(((reclist_data = reclist.getObject("topic_id"))==null || reclist.wasNull())?"":reclist_data)%></td>
            <td height="20" ><span class="style24"><%=(((reclist_data = reclist.getObject("type"))==null || reclist.wasNull())?"":reclist_data)%></span></td>
            <td height="20" colspan="3"><span class="style24"><A HREF="topic_hits.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((reclist_data = reclist.getObject("topic_id"))==null || reclist.wasNull())?"":reclist_data) %>"><%=(((reclist_data = reclist.getObject("topic"))==null || reclist.wasNull())?"":reclist_data)%></A></span></td>
            <td height="20"><p class="coltext style30"><%=(((reclist_data = reclist.getObject("poster"))==null || reclist.wasNull())?"":reclist_data)%></p></td>
...
%>
    ...
    <table width="683" height="28" border="0" align="center">
      <tr>
        <td width="437"><div align="right"><span class="style29"><a href="admin/admin.jsp" target="_blank" class="style24">管理員</a>||<a href="term.jsp" class="style24">名詞搜索</a> || <a href="contact.jsp" class="style24">意見 </a></span></div></td>
      </tr>
    </table>
</div>
</body>
