...
%>
          <span class="style27">||</span> <span class="style27"><a href="bulletin_news.jsp" class="style5">相關消息</a> || <a href="lesson.jsp" class="style5">課程</a> || <a href="forum.jsp" class="style5">討論區</a> ||<a href="message.jsp" class="style5">留言</a> || <a href="linkpage.jsp" class="style5">連結</a></span></div></td>
      </tr>
    </table>
    <p>&nbsp;</p>
...
<div class="bottom">
  ...
  <table width="683" height="28" border="0" align="center">
    <tr>
      <td width="437"><div align="right"><span class="style27"><a href="admin/admin.jsp" target="_blank" class="style5">管理員</a>||<a href="term.jsp" class="style5">名詞搜索</a> || <a href="contact.jsp" class="style5">意見 </a></span></div></td>
    </tr>
  </table>
</div>
</div>
