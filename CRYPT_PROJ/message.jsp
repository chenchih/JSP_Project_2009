...
%>
          <span class="style27">||</span> <span class="style27"><a href="bulletin_news.jsp" class="style24">相關消息</a> || <a href="lesson.jsp" class="style24">課程</a> || <a href="forum.jsp" class="style24">討論區</a> ||<a href="message.jsp" class="style24">留言</a> || <a href="linkpage.jsp" class="style24">連結</a></span></div></td>
      </tr>
    </table>
	<!-- end #menu -->
<br>
<table border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00" background="images/board2.jpg">
  <tr>
    <td align="center" valign="top"><table width="594"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        <tr>
          <td height="68">&nbsp;</td>
        </tr>
        <tr>
          <td><table width="496" border="3" align="center" cellpadding="1" cellspacing="2" bordercolor="#6F921A">
              <tr>
                <td width="407" valign="top" bgcolor="#FFFFFF"><img src="images/message.jpg" width="750" height="110" /></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          <td valign="bottom">
            <table width="100%" height="100%" border="0" align="center" cellpadding="1" cellspacing="2">
              <tr valign="bottom">
                ...
                <td width="16%"><a href="admin.jsp"></a></td>
              </tr>
          </table>          </td>
        </tr>
      </table>
        <table width="100%" align="center" cellpadding="2" cellspacing="1" class="box">
          ...
          <tr valign="middle" bgcolor="#FFFFFF">
            ...
            <td height="20"><p class="coltext style28"><%=(((reclist_data = reclist.getObject("poster"))==null || reclist.wasNull())?"":reclist_data)%></p></td>
            <td height="20"><span class="style29"><%=(((reclist_data = reclist.getObject("newtime"))==null || reclist.wasNull())?"":reclist_data)%></span></td>
            <td height="20"><div align="center"><span class="style29"><%=(((reclist_data = reclist.getObject("hits"))==null || reclist.wasNull())?"":reclist_data)%></span></div></td>
            <td height="20"><div align="center"><span class="style29"><%=(((reclist_data = reclist.getObject("recount"))==null || reclist.wasNull())?"":reclist_data)%></span></div></td>
          </tr>
          <%
  Repeat1__index++;
  reclist_hasData = reclist.next();
...
<table width="683" height="28" border="0" align="center">
  <tr>
    <td width="437"><div align="right"><span class="style27"><a href="admin/admin.jsp" target="_blank" class="style24">管理員</a>||<a href="term.jsp" class="style24">名詞搜索</a> || <a href="contact.jsp" class="style24">意見 </a></span></div></td>
  </tr>
</table>
</div>
</body>
