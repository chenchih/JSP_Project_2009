...
%>
          <span class="style27">||</span> <span class="style27"><a href="bulletin_news.jsp" class="style37">相關消息</a> || <a href="lesson.jsp" class="style37">課程</a> || <a href="forum.jsp" class="style37">討論區</a> ||<a href="message.jsp" class="style37">留言</a> || <a href="linkpage.jsp" class="style37">連結</a></span></div></td>
      </tr>
    </table>
    <p>&nbsp;</p>
    <table border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00" background="images/board.jpg">
  <tr>
    <td width="766" valign="top"><table width="610"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        <tr>
          <td height="68">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          <td height="50">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="16%"><a href="admin_login.jsp"></a></td>
                            ...
                            <td  height="20">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="10">&nbsp;</td>
                                  <td valign="baseline">
                                    <div align="center"><font face="新細明體" size="2"><a href="message.jsp" class="style37">回主畫面</a> / <a href="message_re.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((rectopic_data = rectopic.getObject("topic_id"))==null || rectopic.wasNull())?"":rectopic_data) %>" class="style37">回應</a></font></div></td>
                                </tr>
                            </table></td>
                          </tr>
                        </table>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="142" align="center">
                              ...
                              <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="10">&nbsp;</td>
                                    <td valign="baseline"><div align="center"><font face="新細明體" size="2"><a href="message.jsp" class="style37">回主畫面</a> / <A HREF="message_re.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((recre_data = recre.getObject("topic_id"))==null || recre.wasNull())?"":recre_data) %>" class="style37">回應</A></font></div></td>
                                  </tr>
                                </table></td>
                          </tr>
                        </table>
...
<div class="bottom">
  ...
  <table width="683" height="28" border="0" align="center">
    <tr>
      <td width="437"><div align="right"><span class="style27"><a href="admin/admin.jsp" target="_blank" class="style37">管理員</a>||<a href="term.jsp" class="style37">名詞搜索</a> || <a href="contact.jsp" class="style37">意見 </a></span></div></td>
    </tr>
  </table>
</div>
</div>
