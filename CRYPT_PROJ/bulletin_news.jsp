...
<%@ include file="admin/news/Connections/mynews.jsp" %>
<%
...
<div id="wrapper">
  ...
  if(userid1.equals(""))
	{
	  out.print(""); 
	  out.print("  <a href = signin.jsp target=_parent> <font color=blue >  登入  </font> </a> "); 
                              ...
                              <tr>
                                <td><table width="100%" border="0" cellpadding="4" cellspacing="1" class="box">
                                    ...
                                    <tr valign="baseline" bgcolor="#EEEEEE">
                                      ...
                                      <td><span class="style5"><span class="style19"><font size="-1" face="Verdana, Arial, Helvetica, sans-serif">[</font></span><span class="style18"><font face="Verdana, Arial, Helvetica, sans-serif"><%=(((newslist_data = newslist.getObject("news_type"))==null || newslist.wasNull())?"":newslist_data)%></font></span><font size="-1" face="Verdana, Arial, Helvetica, sans-serif"><span class="style19">]</span>&nbsp; </font></span><font face="Verdana, Arial, Helvetica, sans-serif"><a href="news_show.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "news_id=" + (((newslist_data = newslist.getObject("news_id"))==null || newslist.wasNull())?"":newslist_data) %>" class="style5"><%=(((newslist_data = newslist.getObject("news_title"))==null || newslist.wasNull())?"":newslist_data)%></a></font></td>
        ...
        <tr>
          <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                ...
                <td width="190"><img src="images/icons_1.gif" width="38" height="35" border="0" alt=""></td>
                <td>&nbsp;</td>
