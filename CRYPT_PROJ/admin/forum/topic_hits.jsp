...
PreparedStatement counthits = Conncounthits.prepareStatement("UPDATE topic  SET hits=hits+1  WHERE topic_id="+ counthits__topicid + " ");
...
Conncounthits.close();
%>
<jsp:forward page="forum_topic.jsp" />