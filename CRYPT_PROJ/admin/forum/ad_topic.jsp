...
PreparedStatement Statementrecupdtopic = Connrecupdtopic.prepareStatement("SELECT *  FROM topic  WHERE topic_id = " + recupdtopic__MMColParam + "");
...
PreparedStatement Statementrecupdre = Connrecupdre.prepareStatement("SELECT * FROM retopic WHERE topic_id = " + recupdre__MMColParam + " ORDER BY re_posttime DESC");
...
<body text="#000000">
  ...
  <tr>
    <td height="76"><table width="200" border="3" align="center" cellpadding="0" cellspacing="2">
      <tr>
                                ...
                                <table width="95%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#DFDFDF" class="boxRed">
                                  <tr>
                                    <td width="123" valign="top">
                                      <div align="center">                                        
                                        <p><br />
                                          <img name="face" src="images/face/<%=(((recupdtopic_data = recupdtopic.getObject("face"))==null || recupdtopic.wasNull())?"":recupdtopic_data)%>" width="100" height="120" alt="表情"><br>
                                          <%=(((recupdtopic_data = recupdtopic.getObject("poster"))==null || recupdtopic.wasNull())?"":recupdtopic_data)%></p>
                                        <table width="89%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="10">&nbsp;</td>
                                            <td valign="baseline"><div align="center"><font face="新細明體" size="2"><a href="forum_admin.jsp" class="style5">回管理主畫面</a></font></div></td>
                                          </tr>
                                        </table>
                                        <p>&nbsp;</p>
                                      </div></td>
                                  ...
                                  <table width="95%" border="0" cellspacing="0" cellpadding="5" align="center"  bgcolor="#FFFFFF">
                                        <tr>
                                          <td height="12" colspan="2"> <div align="left"><font color="#003399"><strong></strong></font><font size="1" face="Arial, Helvetica, sans-serif">
                                            </font><font face="Arial, Helvetica, sans-serif"><span class="style39">主題: </span></font><font size="1" face="Arial, Helvetica, sans-serif">
                                          ...
                                          <p align="left"><font face="Arial, Helvetica, sans-serif">										  </font><font face="Arial, Helvetica, sans-serif"><span class="style39">內容:</span></font><font color="#0066CC" size="-1">
                                        ...
                                        <tr>
                                          <td width="55%" height="13"> <span class="style37">(time:</span><span class="style37"><%=(((recupdtopic_data = recupdtopic.getObject("posttime"))==null || recupdtopic.wasNull())?"":recupdtopic_data)%></span></td>
                                          <td width="45%"><div align="right"><font face="Arial, Helvetica, sans-serif"><span class="style20">ip:</span></font><span class="style20"><%=(((recupdtopic_data = recupdtopic.getObject("ip"))==null || recupdtopic.wasNull())?"":recupdtopic_data)%></span><font face="Arial, Helvetica, sans-serif"><span class="style20">) </span></font></div></td>
                                        </tr>
                                    </table>
      ...
      <table width="95%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#CCFFCC" class="boxGray">
        <tr>
          <td width="123" valign="top"><div align="center">
            <p><br />
                <img src="images/face/<%=(((recupdre_data = recupdre.getObject("re_face"))==null || recupdre.wasNull())?"":recupdre_data)%>" alt="表情" name="reface" width="100" height="120" id="reface"><br>
            ...
            <table width="93%" height="14" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="center"><font size="2" face="新細明體"><a href="ad_delre.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "re_id=" + (((recupdre_data = recupdre.getObject("re_id"))==null || recupdre.wasNull())?"":recupdre_data) %>" class="style5">刪除留言</a> | <a href="forum_admin.jsp" class="style5">回主畫面</a></font></div></td>
                </tr>
            </table>
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="5" align="center"  bgcolor="#FFFFFF">
              <tr>
                <td height="12" colspan="2"><font color="#003399"><strong></strong></font><font size="1" face="Arial, Helvetica, sans-serif">
              ...
              <tr>
                <td width="54%" height="13"><font size="1" face="Arial, Helvetica, sans-serif">&nbsp; </font><font face="Arial, Helvetica, sans-serif"><span class="style20"> (time:<%=(((recupdre_data = recupdre.getObject("re_posttime"))==null || recupdre.wasNull())?"":recupdre_data)%></span></font></td>
                <td width="46%"><div align="right"><font face="Arial, Helvetica, sans-serif"><span class="style20">ip:<%=(((recupdre_data = recupdre.getObject("re_ip"))==null || recupdre.wasNull())?"":recupdre_data)%>)</span></font></div>
                  </td>
              </tr>
            </table>
              <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
