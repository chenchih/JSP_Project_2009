...
<p>&nbsp;</p>
  ...
  <tr>
    <td width="766" valign="top"><table width="626"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        <tr>
          <td width="622" height="68"><% String name=((String)session.getAttribute("uid")==null)?"":(String)session.getAttribute("uid");  if(name.equals("")){
 ...
 %></td>
        ...
        <tr>
          <td><table width="200" border="3" align="center" cellpadding="0" cellspacing="2" bordercolor="#6F921A">
              <tr>
                <td bgcolor="#FFFFFF"><table width="200" border="3" align="center" cellpadding="0" cellspacing="2">
                  <tr>
          ...
          <td height="50">
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td width="16%"><div align="center"><a href="forum_add.jsp" class="style45">新增留言</a></div></td>
              </tr>
          </table></td>
        </tr>
      </table>
            ...
            <td valign="top">
                            ...
                            <td  height="20">
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="10">&nbsp;</td>
                                  <td valign="baseline">
                                    <div align="center"><font face="新細明體" size="2"><a href="forum.jsp" class="style37">回主畫面</a> / <a href="forum_re.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((rectopic_data = rectopic.getObject("topic_id"))==null || rectopic.wasNull())?"":rectopic_data) %>" class="style37">回應</a></font></div></td>
                                </tr>
                            </table></td>
                          </tr>
                        </table>
                  ...
                  <td valign="top">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#DFDFDF">
                      <tr>
                        ...
                        <td width="49%" class="style21"><div align="left"><span class="style36"> 張 貼 者 ：</span><span class="style44"><span class="style43"><%=(((rectopic_data = rectopic.getObject("poster"))==null || rectopic.wasNull())?"":rectopic_data)%></span></span></div></td>
              ...
              <% while ((recre_hasData)&&(Repeat1__numRows-- != 0)) { %>
                ...
                <table width="95%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#EFEFEF">
                  <tr>
                    <td width="150" valign="top"><div align="center"><img src="images/face/<%=(((recre_data = recre.getObject("re_face"))==null || recre.wasNull())?"":recre_data)%>" alt="表情" name="reface" width="100" height="120" id="reface"><br>
                        <font face="Verdana, 新細明體" size="2"></font>
                        <table border="0" cellspacing="0" cellpadding="0" width="142" align="center">
                              <tr>
                                <td></td>
                              ...
                              <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="10">&nbsp;</td>
                                    <td valign="baseline"><div align="center"><font face="新細明體" size="2"><a href="forum.jsp">回主畫面</a> / <A HREF="forum_re.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((recre_data = recre.getObject("topic_id"))==null || recre.wasNull())?"":recre_data) %>">回應</A></font></div></td>
                                  </tr>
                                </table></td>
                          </tr>
                        </table>
                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center"  bgcolor="#DFDFDF">
                        <tr>
                          ...
                          <td width="50%" class="style21"><div align="left"><span class="style36">張 貼 者 ：</span><span class="style44"><span class="style43"><span class="style25"><%=(((recre_data = recre.getObject("re_poster"))==null || recre.wasNull())?"":recre_data)%></span></span></span></div></td>
                          <td width="48%" rowspan="2"><span class="style21"><span class="style25"><span class="style29"><span class="style44">討論主題:</span> <%=(((recre_data = recre.getObject("re_topic"))==null || recre.wasNull())?"":recre_data)%></span></span></span></td>
                        </tr>
                        <tr>
