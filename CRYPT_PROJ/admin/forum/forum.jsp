...
<table width="623" border="0" align="center">
  <tr>
    <td width="613"><div align="center"><span class="style58"><a href="../signout.jsp" class="style24">登出 </a>|| <a href="../all_entry.jsp" class="style24">使用者資料</a> || <a href="../search.jsp" class="style24">搜索 </a>|| <a href="../add_term.jsp" class="style24">新增名詞</a> || <a href="../news/news.jsp" class="style24">相關消息</a> ||<a href="../suggestion.jsp" class="style24"> 意見</a> || <a href="forum.jsp" class="style24">討論區</a> ||<a href="../message/message.jsp" class="style24"> 留言</a></span></div></td>
  </tr>
</table>
<p>&nbsp;</p>
    <table border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00" background="images/board.jpg">
      <tr>
        <td width="771" align="center" valign="top"><table  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
            <tr>
 ...
 %></td>
            ...
            <tr>
              <td><table width="200" border="3" align="center" cellpadding="1" cellspacing="2" bordercolor="#6F921A">
                  <tr>
                    <td valign="top" bgcolor="#FFFFFF"><table width="200" border="3" align="center" cellpadding="0" cellspacing="2">
                        <tr>
            ...
            <tr>
              <td valign="bottom"><table width="100%" height="100%" border="0" align="center" cellpadding="1" cellspacing="2">
                  <tr valign="bottom">
                    <td width="16%" height="50"><div align="center"><a href="forum_add.jsp" class="style59">新增</a></div></td>
                    <td width="67%" valign="middle"><span class="style18"> </span>
                        <table width="100%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FF9933">
                          <tr>
                    ...
                    <td width="16%"><a href="admin_login.jsp"></a><a href="forum_admin.jsp"><img src="images/forum_admin.gif" width="120" height="48" border="0"></a></td>
                  </tr>
              </table></td>
            </tr>
          </table>
            <table width="100%" align="center" cellpadding="2" cellspacing="1" class="box">
              ...
              <tr valign="middle" bgcolor="#FFFFFF">
                <td height="20" ><span class="style60"><%=(((reclist_data = reclist.getObject("type"))==null || reclist.wasNull())?"":reclist_data)%></span></td>
                <td height="20" colspan="3"><div align="center"><span class="style24"><a href="topic_hits.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((reclist_data = reclist.getObject("topic_id"))==null || reclist.wasNull())?"":reclist_data) %>"><%=(((reclist_data = reclist.getObject("topic"))==null || reclist.wasNull())?"":reclist_data)%></a></span></div></td>
                <td height="20"><p class="coltext style60"><%=(((reclist_data = reclist.getObject("poster"))==null || reclist.wasNull())?"":reclist_data)%></p></td>
                <td height="20"><span class="style61"><%=(((reclist_data = reclist.getObject("newtime"))==null || reclist.wasNull())?"":reclist_data)%></span></td>
                <td height="20"><div align="center"><span class="style62"><%=(((reclist_data = reclist.getObject("hits"))==null || reclist.wasNull())?"":reclist_data)%></span></div></td>
                <td height="20"><div align="center"><span class="style62"><%=(((reclist_data = reclist.getObject("recount"))==null || reclist.wasNull())?"":reclist_data)%></span></div></td>
              </tr>
              <%
  Repeat1__index++;
  reclist_hasData = reclist.next();
...
%>
              ...
              <tr>
                <td height="15" colspan="8"><div align="right">
                    <% if (reclist_isEmpty ) { %>
