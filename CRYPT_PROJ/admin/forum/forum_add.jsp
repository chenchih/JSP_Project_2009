...
<body topmargin="2" marginheight="2" leftmargin="2" marginwidth="2">
<table width="623" border="0" align="center">
  <tr>
    <td width="613"><div align="center"><span class="style18"><a href="../signout.jsp" class="style21">登出 </a>|| <a href="../all_entry.jsp" class="style21">使用者資料</a> || <a href="../search.jsp" class="style21">搜索 </a>|| <a href="../add_term.jsp" class="style21">新增名詞</a> || <a href="../news/news.jsp" class="style21">相關消息</a> ||<a href="../suggestion.jsp" class="style21"> 意見</a> || <a href="forum.jsp" class="style21">討論區</a> ||<a href="../message/message.jsp" class="style21"> 留言</a></span></div></td>
  </tr>
</table>
<p>&nbsp;</p>
...
{response.sendRedirect("http://localhost:8080/acc/admin/admin.jsp");}
 ...
 %></td>
        ...
        <tr>
          <td height="55" bgcolor="#C4DF82"><div align="center" class="style20"><font face="Verdana, 新細明體"><span class="style22">■ 發表新主題 ■</span></font><font color="#FFFFFF" face="Verdana, 新細明體"><font color="#FFFFFF" face="Verdana, 新細明體">
            <%
                  ...
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                    ...
                    <tr>
                      ...
                      <td width="446" height="30"><font size="2" face="新細明體"> 　
                              ...
                              </span></font><span class="style22"><font face="Verdana, 新細明體">
<% out.print(userid); %>
                              </font> </span></td>
