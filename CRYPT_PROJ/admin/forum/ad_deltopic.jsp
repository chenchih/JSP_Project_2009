...
PreparedStatement Statementrecdeltopic = Connrecdeltopic.prepareStatement("SELECT * FROM account.topic WHERE topic_id = " + recdeltopic__MMColParam + "");
...
<p>&nbsp;</p>
  ...
  <tr>
    <td height="338" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" background="images/admin_board.jpg" class="fixbox">
        <tr>
          <td height="61" colspan="3" align="center" valign="middle"><% String name=((String)session.getAttribute("uid")==null)?"":(String)session.getAttribute("uid");  if(name.equals("")){
          ...
          <td width="34%" height="68" align="center" valign="bottom"><div align="center">              </div>
              ...
              <tr>
                <td valign="bottom"><form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
                    ...
                    <input name="Submit2" type="button" onClick="MM_goToURL('parent','forum_admin.jsp');return document.MM_returnValue" value="回上一頁">
                </form></td>
              </tr>
                        </table></td>
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#EFEFEF" class="box">
                        ...
                        <tr>
                          <td width="213" valign="top">
                            <div align="center"><img name="face" src="images/face/<%=(((recdeltopic_data = recdeltopic.getObject("face"))==null || recdeltopic.wasNull())?"":recdeltopic_data)%>" width="100" height="120" alt="表情"><br>
                                <font face="Verdana, 新細明體" size="2"></font>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td height="18"><div align="center"><span class="style20"><span class="style35">〔<span class="style54"></span><%=(((recdeltopic_data = recdeltopic.getObject("type"))==null || recdeltopic.wasNull())?"":recdeltopic_data)%>〕</span></span></div></td>
                                  </tr>
                                </table>
                            </div></td>
                          <td valign="top">
                            ...
                            <table width="103%" border="0" align="center" cellpadding="0" cellspacing="0"  bgcolor="#DFDFDF">
                              <tr>
                                ...
                                <td width="39%" height="19" class="style20"><div align="left"><span class="style36"> 張 貼 者：</span><span class="style44"><span class="style43"> </span></span><%=(((recdeltopic_data = recdeltopic.getObject("poster"))==null || recdeltopic.wasNull())?"":recdeltopic_data)%></div></td>
                                <td width="53%" rowspan="2"><span class="style53"><%=(((recdeltopic_data = recdeltopic.getObject("topic"))==null || recdeltopic.wasNull())?"":recdeltopic_data)%></span></td>
                              </tr>
                              <tr>
