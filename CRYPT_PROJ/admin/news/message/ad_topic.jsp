...
<table width="761" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00">
  <tr>
    <td height="130"><table width="100%" border="3" align="center" cellpadding="3" cellspacing="2">
        <tr>
          <td><div align="center"><img src="images/message.jpg" width="750" height="110" /></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
    <td height="585" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" background="images/board2.jpg" class="fixbox">
        <tr>
                  ...
                  <td height="461" valign="top">                        <table border="0" align="center" cellpadding="0" cellspacing="0" background="images/line02.gif">
                          ...
                          <tr>
                            <td valign="top">                              <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
                                <table width="102%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#DFDFDF" class="boxRed">
                                  <tr>
                                    <td width="123" valign="top">
                                      <div align="center">                                        
                                        ...
                                        <table width="89%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="10">&nbsp;</td>
                                            <td valign="baseline"><div align="center"><font face="新細明體" size="2"><a href="admin.jsp">回管理員  </a></font></div></td>
                                          </tr>
                                        </table>
                                        <p>&nbsp;</p>
                                    </div></td>
                                  ...
                                  <table width="95%" border="0" cellspacing="0" cellpadding="5" align="center"  bgcolor="#FFFFFF">
                                        <tr>
                                          <td height="12" colspan="2"> 
                                            <font face="Arial, Helvetica, sans-serif"><span class="style39">主題: </span></font><font size="1" face="Arial, Helvetica, sans-serif">                                          
                                            ...
                                            <hr noshade size="1">	
                                            <span class="style39">內容:</span> </font><font color="#0066CC" size="-1">
      ...
      <table width="95%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#CCFFCC" class="boxGray">
        <tr>
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="5" align="center"  bgcolor="#FFFFFF">
              <tr>
                <td height="12" colspan="2">
                  <font face="Arial, Helvetica, sans-serif">  <span class="style44"><strong>主題</strong>:</span></font><font size="1" face="Arial, Helvetica, sans-serif">
                  ...
                  <hr noshade size="1"> <font face="Arial, Helvetica, sans-serif"><span class="style39">內容:</span> </font>
