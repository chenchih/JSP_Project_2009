...
<table width="764" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00">
  ...
  <tr>
    <td height="338" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" background="images/board2.jpg" class="fixbox">
        <tr>
              ...
              <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00" class="box">
                <tr>
                  <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="84%"><div align="left"><span class="style47"><span class="style48"><span class="style49">欲刪除的討論主題：</span></span><span class="style51"><%=(((recdeltopic_data = recdeltopic.getObject("topic"))==null || recdeltopic.wasNull())?"":recdeltopic_data)%></span></span></div></td>
