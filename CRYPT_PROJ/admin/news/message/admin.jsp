...
<table width="764" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00">
  ...
  <tr>
    <td height="289" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2" background="images/board2.jpg" class="fixbox">
        <tr>
              ...
              <tr>
                <td height="203" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="16%"><a href="message.jsp">使用者介面</a></td>
                  </tr>
                  ...
                  <tr bgcolor="#098DA5" class="tr-f">
                    ...
                    <td width="225"><span class="style16"><span class="style6 coltext"><strong>討論主題</strong></span> </span></td>
                    <td width="96"><p class="style6 coltext"><span class="style16">發表人</span></p></td>
                    <td width=156><span class="style16">最新回應日期 </span></td>
                  ...
                  <tr valign="middle" bgcolor="#F3F3F3" class="tr-f">
                    ...
                    <td height="20"><A HREF="ad_topic.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((reclist_data = reclist.getObject("topic_id"))==null || reclist.wasNull())?"":reclist_data) %>"><%=(((reclist_data = reclist.getObject("topic"))==null || reclist.wasNull())?"":reclist_data)%></A></td>
...
%>
                  <tr>
                    <td colspan="8"><div align="center" class="style17">
                  ...
                  <% } /* end !reclist_isEmpty */ %>
                    <tr valign="top">
                      <td height="50" colspan="8"><div align="right">
                        <% if (reclist_isEmpty ) { %>
