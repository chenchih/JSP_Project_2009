                        ...
                        <table border="0" width="52%" align="center">
                          <tr>
                            <td width="23%" align="center">
                              <% if (MM_offset !=0) { %>
                              <a href="<%=MM_moveFirst%>" class="style59">第一頁</a>
                              <% } /* end MM_offset != 0 */ %>
                            </td>
                            <td width="31%" align="center">
                              <% if (MM_offset !=0) { %>
                              <a href="<%=MM_movePrev%>" class="style59">上一頁</a>
                              <% } /* end MM_offset != 0 */ %>
                            </td>
                            <td width="23%" align="center">
                              <% if (!MM_atTotal) { %>
                              <a href="<%=MM_moveNext%>" class="style59">下一頁</a>
                              <% } /* end !MM_atTotal */ %>
                            </td>
                            <td width="23%" align="center">
                              <% if (!MM_atTotal) { %>
                              <a href="<%=MM_moveLast%>" class="style59">最後一頁</a>
                              <% } /* end !MM_atTotal */ %>
                            </td>
                          </tr>
                        </table>
