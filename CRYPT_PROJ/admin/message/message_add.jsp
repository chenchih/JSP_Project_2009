...
<p>&nbsp;</p>
    <table width="706" border="3" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFF00" class="fixbox">
  <tr>
    <td width="698" height="497" valign="top"><table width="100%" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        <tr>
          <td width="698" height="71" bgcolor="#FFFFFF"><% String name=((String)session.getAttribute("uid")==null)?"":(String)session.getAttribute("uid");  if(name.equals("")){
...
{response.sendRedirect("http://localhost:8080/acc/admin/admin.jsp");}
 ...
 %></td>
        ...
        <tr>
          <td height="55" bgcolor="#C1DC7D"><div align="center" class="style20 style27"><font face="Verdana, 新細明體">■ 發表新留言主題 ■</font></div></td>
        </tr>
        <tr>
              ...
              <tr>
                <td valign="top">
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="box">
                    <tr>
                      <td width="76" height="30" bgcolor="#a3d3ad">
                    ...
                    <tr>
                      ...
                      <td width="600" height="30"><font size="2" face="新細明體"> 　
