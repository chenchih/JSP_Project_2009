...
<body>
    ...
    <p class="style5"><a href="add_delete.jsp" class="style5"></a></p>
    <table width="392" height="21" border="1" align="center">
  <tr>
    <td width="135"><div align="center"><span class="style9"><a href="all_entry.jsp" class="style5">所有資料</a><a href="all_entry.jsp"></a></span></div></td>
    <td width="117" bgcolor="#CC0000"><div align="center"><span class="style9">資料分頁</span></div></td>
...
<table width="190%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="3">&nbsp;</td>
    <td width="1343" valign="top"><table width="94%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="7" height="8">&nbsp;</td>
          <td width="1256"> <div align="left">記錄 <%=(Recordset1_first)%> 到 <%=(Recordset1_last)%> 共 <%=(Recordset1_total)%> </div></td>
        </tr>
        <tr>
          <td height="8">&nbsp;</td>
          <td style="word-break:break-all"><table width="100%" border="0" cellspacing="0" cellpadding="4">
              <tr>
                <td>
                  <% if (!Recordset1_isEmpty ) { %>
                  <table width="1289" border="1">
                    <tr>
                      <td width="118" height="19" bgcolor="#99FF00"><div align="center">註冊時間</div></td>
                      <td width="97" bgcolor="#99FF00"><div align="center">使用者帳號</div></td>
                      <td width="89" bgcolor="#99FF00"><div align="center">密碼</div></td>
                      <td width="94" bgcolor="#99FF00"><div align="center">姓名</div></td>
                      <td width="100" bgcolor="#99FF00"><div align="center">性別</div></td>
                      <td width="88" bgcolor="#99FF00"><div align="center">年</div></td>
                      <td width="99" bgcolor="#99FF00"><div align="center">月</div></td>
                      <td width="87" bgcolor="#99FF00"><div align="center">日</div></td>
                      <td width="104" bgcolor="#99FF00"><div align="center">地址</div></td>
                      <td width="94" bgcolor="#99FF00"><div align="center">電子信箱</div></td>
                      <td width="97" bgcolor="#99FF00"><div align="center">電話</div></td>
                      <td width="146" bgcolor="#99FF00"><div align="center">更新時間</div></td>
                    </tr>
                    ...
                    <tr bgcolor="#99FFFF">
                      ...
                      <td><%=(((Recordset1_data = Recordset1.getObject("userid"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("pwd"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("name"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><div align="center"><%=(((Recordset1_data = Recordset1.getObject("gender"))==null || Recordset1.wasNull())?"":Recordset1_data)%></div></td>
                      <td><div align="center"><%=(((Recordset1_data = Recordset1.getObject("year"))==null || Recordset1.wasNull())?"":Recordset1_data)%></div></td>
                      <td><div align="center"><%=(((Recordset1_data = Recordset1.getObject("month"))==null || Recordset1.wasNull())?"":Recordset1_data)%></div></td>
                      <td><div align="center"><%=(((Recordset1_data = Recordset1.getObject("date"))==null || Recordset1.wasNull())?"":Recordset1_data)%></div></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("address"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("email"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("phone"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                      <td><%=(((Recordset1_data = Recordset1.getObject("edit_id"))==null || Recordset1.wasNull())?"":Recordset1_data)%></td>
                    </tr>
                    <%
  Repeat1__index++;
  Recordset1_hasData = Recordset1.next();
