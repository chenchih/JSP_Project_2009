...
%>
            <span class="style46">||</span> <span class="style46"><a href="bulletin_news.jsp" class="style37">相關消息</a> || <a href="lesson.jsp" class="style37">課程</a> || <a href="forum.jsp" class="style37">討論區</a> ||<a href="message.jsp" class="style37">留言</a> || <a href="linkpage.jsp" class="style37">連結</a></span></div></td>
      </tr>
    </table>
  <p>&nbsp;</p>
    ...
    <td width="766" valign="top"><table  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
        ...
        <tr>
          <td><table width="200" border="3" align="center" cellpadding="0" cellspacing="2" bordercolor="#6F921A">
              <tr>
                <td><img src="images/forum_pic.jpg" width="750" height="110"></td>
              </tr>
          </table></td>
        </tr>
        <tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" width="142" align="center">
                              ...
                              <tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="10">&nbsp;</td>
                                    <td valign="baseline"><div align="center"><font face="新細明體" size="2"><a href="forum.jsp" class="style37">回主畫面</a> / <A HREF="forum_re.jsp?<%= MM_keepNone + ((MM_keepNone!="")?"&":"") + "topic_id=" + (((recre_data = recre.getObject("topic_id"))==null || recre.wasNull())?"":recre_data) %>" class="style37">回應</A></font></div></td>
                                  </tr>
                                </table></td>
                          </tr>
                        </table>
