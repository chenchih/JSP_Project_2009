...
<form id="test" name="test" method="post" action="">
  <p align="center" class="style1">DES 測驗 </p>
  <hr />
  <p>
    <%
...
if(question2.equals("1")||(question2.equals("2")))
